...
public class UserCommandHandler implements Runnable{
    ...
    public void run() {
        switch (Integer.parseInt((CharSequence)theCommand, 0, 1, 10)) {
            case 1: //QUIT
                myServer.stopServer();
            ...
            case 2: //LISTEN
                ...
                break;
            case 3: //SET PORT
                int portNumber = Integer.parseInt((CharSequence)theCommand, 2, 6, 10);
                myServer.setPort(portNumber);
                myUI.update("The port number has been set to " + portNumber + "\n");
                break;
            case 4: //GET PORT
