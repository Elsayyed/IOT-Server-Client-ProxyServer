...
public class ProxyMessageHandler {
    ...
    //ProxyMessageHandler Constructor
    public ProxyMessageHandler(server.Server myServer, client.Client myClient) {
    ...
    //Function used to link the client connection to the ProxyMessageHandler
    ...
    public void handleCompleteAndroidMessage(clientconnection.ClientConnection myAndroidConnection, String theCommand){
        ...
        switch (theCommand) {
            case "d":
                myAndroidConnection.sendStringMessageToClient("Disconnect Ack: " +
                        myAndroidConnection.getClientSocket().getRemoteSocketAddress());
            ...
            case "t":
                ...
                break;
            default:
                clientToBoard.sendMessageToServer(theCommand); clientToBoard.sendMessageToServer((byte)0xFF);
                break; } }
