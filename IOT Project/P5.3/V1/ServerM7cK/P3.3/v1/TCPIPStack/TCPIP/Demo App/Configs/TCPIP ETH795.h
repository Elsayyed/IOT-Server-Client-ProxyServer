...
#define MY_DEFAULT_HOST_NAME			"mxFA"
...
#define MY_DEFAULT_MAC_BYTE5            (0xAC)	// 
#define MY_DEFAULT_MAC_BYTE6            (0xFA)	// 

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (0xFAul) //doubtful
...
#define MY_DEFAULT_GATE_BYTE4           (250ul)
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE4		(250ul)
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(12669+10*2+44+200+20 + (2000+44+2000+2))
//	#define TCP_PIC_RAM_SIZE					(16384ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
            ...
            {TCP_PURPOSE_TCP_TO_UPPER_SERVER, TCP_PIC_RAM, 2000, 2000}
