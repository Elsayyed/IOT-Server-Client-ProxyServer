...
public class Gui extends javax.swing.JFrame implements userinterface.UserInterface {
    ...
    public void update(String theMessage) {
      serverMessageTextArea.append(theMessage+"\n");
    }
    ...
    private void initComponents() {
        ...
        getTimeButton.setText("Get Temperature");
    ...
    private void getTimeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getTimeButtonActionPerformed
        ...
        this.update("Temperature Request Sent!");
 ...
 //       serverMessageTextArea.append("Disconnection from server was successful.\n");
  ...
  //       serverMessageTextArea.append("Quiting the program.\n");
         myUserCommandHandler.handleUserCommand("1");
...
//    }
    ...
    public void PB3SetText(String substring) {
        pb3TextField.setText(substring);
    }

    public void PB2SetText(String substring) {
        pb2TextField.setText(substring);
    }

    public void PB1SetText(String substring) {
        pb1TextField.setText(substring);
    }
