...
public class TimeServerTest {
    ...
    public static void main(String[] args) {
        ...
        timeserverclientmessagehandler.ClientMessageHandler myClientMessageHandler = new timeserverclientmessagehandler.ClientMessageHandler(myServer);
        myServer.setClientMessageHandler(myClientMessageHandler);
        timeserverusercommandhandler.TimeServerUserCommandHandler myUserCommandHandler = new timeserverusercommandhandler.TimeServerUserCommandHandler(myUI, myServer);
